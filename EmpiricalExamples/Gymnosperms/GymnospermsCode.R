...
setwd("/home/jfwalker/Desktop/OutlierSims/EmpiricalExamples/Gymnosperms/")
IhateR4 = read.table("GymnospermAdjusted.txt",sep = "\t",header = TRUE)
a4 = IhateR4[,2]
...
Temp4 = Temp4 +theme(legend.position="none") + ylim(-20,30) + annotate("text", x=498, y=1.31742199999999, label= "X",size=6) 
Temp4 = Temp4 + annotate("text", x=53, y=25.6449649999995, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp4 = Temp4 + ggtitle("Gymnosperm ΔGWLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp4 = Temp4 + geom_vline(xintercept=53,linetype="dashed") + geom_vline(xintercept=498,linetype="dashed")
Temp4
...
Temp3 = Temp3 +theme(legend.position="none") + ylim(-0.1,0.15) + annotate("text", x=53, y=0.0315436223862232, label= "X",size=6) 
Temp3 = Temp3 + annotate("text", x=498, y=0.101340153846153, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp3 = Temp3 + ggtitle("Gymnosperm Average ΔSSLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp3 = Temp3 + geom_vline(xintercept=53,linetype="dashed") + geom_vline(xintercept=498,linetype="dashed")
Temp3
