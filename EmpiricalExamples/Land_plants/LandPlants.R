...
setwd("/home/jfwalker/Desktop/OutlierSims/EmpiricalExamples/Land_plants/")
IhateR4 = read.table("Land_plants_Avg.txt",sep = "\t",header = TRUE)
a4 = IhateR4[,2]
...
Temp4 = Temp4 + annotate("text", x=593, y=21.2590150000005, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp4 = Temp4 + ggtitle("Land Plant ΔGWLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp4 = Temp4 + geom_vline(xintercept=593,linetype="dashed") + geom_vline(xintercept=170,linetype="dashed")
Temp4
...
Temp3 = Temp3 +theme(legend.position="none") + ylim(-0.1,0.15) + annotate("text", x=593, y=0.0767473465703991, label= "X",size=6)
Temp3 = Temp3 + theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp3 = Temp3 + ggtitle("Land Plant Average ΔSSLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp3 = Temp3 + geom_vline(xintercept=593,linetype="dashed") + geom_vline(xintercept=170,linetype="dashed")
Temp3
