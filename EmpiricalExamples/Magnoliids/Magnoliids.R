...
setwd("/home/jfwalker/Desktop/OutlierSims/EmpiricalExamples/Magnoliids/")
IhateR4 = read.table("Angiosperms_Avg.txt",sep = "\t",header = TRUE)
a4 = IhateR4[,2]
...
Temp4 = Temp4 +theme(legend.position="none") + ylim(-100,250) + annotate("text", x=9, y=70.0700470000002, label= "X",size=6) 
Temp4 = Temp4 + annotate("text", x=190, y=215.040246999997, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp4 = Temp4 + ggtitle("Magnoliids ΔGWLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp4 = Temp4 + geom_vline(xintercept=190,linetype="dashed") + geom_vline(xintercept=9,linetype="dashed") 
Temp4
...
Temp3 = Temp3 +theme(legend.position="none") + ylim(-0.2,.7) + annotate("text", x=9, y=0.609304756521741, label= "X",size=6) 
Temp3 = Temp3 + annotate("text", x=190, 0.202676952874644, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp3 = Temp3 + ggtitle("Magnoliids Average ΔSSLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp3 = Temp3 + geom_vline(xintercept=190,linetype="dashed") + geom_vline(xintercept=9,linetype="dashed") 
Temp3
