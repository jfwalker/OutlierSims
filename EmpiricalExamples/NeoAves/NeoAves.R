...
setwd("/home/jfwalker/Desktop/OutlierSims/EmpiricalExamples/Lungfish/")
IhateR4 = read.table("LungfishAvg.txt",sep = "\t",header = TRUE)
a4 = IhateR4[,2]
...
Temp4 = Temp4 +theme(legend.position="none") + ylim(-30,60)  
Temp4 = Temp4 + annotate("text", x=160, y=52.9670399999995, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp4 = Temp4 + ggtitle("Lungfish ΔGWLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp4 = Temp4 + geom_vline(xintercept=160,linetype="dashed") 
Temp4 
...
Temp3 = Temp3 +theme(legend.position="none") + ylim(-0.1,0.1) + annotate("text", x=160, y=0.0728570013755152, label= "X",size=6)
Temp3 = Temp3 + theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp3 = Temp3 + ggtitle("Lungfish Average ΔSSLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp3 = Temp3 + geom_vline(xintercept=160,linetype="dashed") 
Temp3
