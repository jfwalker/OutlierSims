...
setwd("/home/jfwalker/Desktop/OutlierSims/EmpiricalExamples/Amborella/")
IhateR4 = read.table("Amborella_Avg.txt",sep = "\t",header = TRUE)
a4 = IhateR4[,2]
...
Temp4 = Temp4 +theme(legend.position="none") + ylim(-15,25)  
Temp4 = Temp4 + annotate("text", x=1, y=22.2601509999986, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp4 = Temp4 + ggtitle("Amborella ΔGWLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp4 = Temp4 + geom_vline(xintercept=1,linetype="dashed")  + geom_vline(xintercept=498,linetype="dashed")
Temp4
...
Temp3 = Temp3 +theme(legend.position="none") + ylim(-0.2,0.2)  
Temp3 = Temp3 + annotate("text", x=1, y=0.0364323256955787, label= "X",size=6)  +theme(legend.position="none") + geom_abline(intercept = 0, slope = 0)
Temp3 = Temp3 + ggtitle("Amborella Average ΔSSLL")+ theme(plot.title = element_text(face="bold",hjust=0.5),panel.grid.major = element_blank(), panel.grid.minor = element_blank())
Temp3 = Temp3 + geom_vline(xintercept=1,linetype="dashed") + geom_vline(xintercept=498,linetype="dashed")
Temp3
